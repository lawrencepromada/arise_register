...
class UsherHomeScreen extends StatefulWidget {
  final String branchId;
  final String branchName;

  const UsherHomeScreen({
    super.key,
  ...
  @override
  State<UsherHomeScreen> createState() => _UsherHomeScreenState();
}

class _UsherHomeScreenState extends State<UsherHomeScreen> {
  ...
  Future<void> registerPerson() async {
    ...
    try {
      ...
      await _firestore.collection("registrations").add({
        ...
        "registeredById": currentUser?.uid ?? "unknown",
